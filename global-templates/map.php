...
<svg xmlns:cc="http://creativecommons.org/ns#" xmlns:dc="http://purl.org/dc/elements/1.1/"
  xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape"
  xmlns:sodipodi="http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd" xmlns:svg="http://www.w3.org/2000/svg"
  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="us-map"
  preserveAspectRatio="xMinYMin meet" sodipodi:docname="Republican_Party_presidential_primaries_results,_2016.svg"
  ...
  <g id="g5">
    ...
    <a href="http://www.state.hi.us/tax/tax.html" target="_blank">
      <path id="HI" class="state-active" data-info="<div>State: Hawaii</div><div>Capital: Honolulu</div>" fill="#D3D3D3"
    ...
    <path id="AK" data-info="<div>State: Alaska</div><div>Capital: Juneau</div>" fill="#D3D3D3"
    ...
    <path id="FL" data-info="<div>State: Florida</div><div>Capital: Tallahassee</div>" fill="#D3D3D3"
    ...
    <path id="SC" data-info="<div>State: South Carolina</div><div>Capital: Columbia</div>" fill="#D3D3D3"
    ...
    <path id="GA" data-info="<div>State: Georgia</div><div>Capital: Atlanta</div>" fill="#D3D3D3"
    ...
    <a href="http://www.ador.state.al.us" target="_blank">
      <path id="AL" class="state-active" data-info="<div>State: Alabama</div><div>Capital: Montgomery</div>"
        fill="#D3D3D3"
    ...
    <a href="http://www.dor.state.nc.us" target="_blank">
      <path id="NC" class="state-active" data-info="<div>State: North Carolina</div><div>Capital: Raleigh</div>"
        fill="#D3D3D3"
    ...
    <path id="TN" data-info="<div>State: Tennessee</div><div>Capital: Nashville</div>" fill="#D3D3D3"
    ...
    <a href="http://www.tax.state.ri.us" target="_blank">
      <path id="RI" class="state-active" data-info="<div>State: Rhode Island</div><div>Capital: Providence</div>"
        fill="#D3D3D3"
    ...
    <a href="http://www.ct.gov/drs" target="_blank">
      <path id="CT" class="state-active" data-info="<div>State: Connecticut</div><div>Capital: Hartford</div>"
        fill="#D3D3D3"
    ...
    <a href="http://www.dor.state.ma.us" target="_blank">
      <path id="MA" class="state-active" data-info="<div>State: Massachusetts</div><div>Capital: Boston</div>"
        fill="#D3D3D3"
        d="M1074,273.9l2.2-0.7l0.5-1.7l1,0.1l1,2.3l-1.3,0.5l-3.9,0.1L1074,273.9z M1064.6,274.7l2.3-2.6h1.6   l1.8,1.5l-2.4,1l-2.2,1L1064.6,274.7z M1029.8,252.7l17.5-4.2l2.3-0.6l2.1-3.2l3.7-1.7l2.9,4.4l-2.4,5.2l-0.3,1.5l1.9,2.6l1.1-0.8   h1.8l2.3,2.6l3.9,6l3.6,0.5l2.3-1l1.8-1.8l-0.8-2.7l-2.1-1.6l-1.5,0.8l-1-1.3l0.5-0.5l2.1-0.2l1.8,0.8l1.9,2.4l1,2.9l0.3,2.4   l-4.2,1.5l-3.9,1.9l-3.9,4.5l-1.9,1.5v-1l2.4-1.5l0.5-1.8l-0.8-3.1l-2.9,1.5l-0.8,1.5l0.5,2.3l-2.1,1l-2.7-4.5l-3.4-4.4l-2.1-1.8   l-6.5,1.9l-5.1,1.1l-21.8,4.8l-0.4-4.9l0.6-10.6l5.2-0.9L1029.8,252.7z" />
    </a>

    <a href="http://www.state.me.us/revenue" target="_blank">
      <path id="ME" class="state-active" data-info="<div>State: Maine</div><div>Capital: Augusta</div>" fill="#D3D3D3"
    ...
    <a href="http://www.state.nh.us/revenue/index.htm" target="_blank">
      <path id="NH" class="state-active" data-info="<div>State: New Hampshire</div><div>Capital: Concord</div>"
        fill="#D3D3D3"
    ...
    <a href="http://www.state.vt.us/tax" target="_blank">
      <path id="VT" class="state-active" data-info="<div>State: Vermont</div><div>Capital: Montpelier</div>"
        fill="#D3D3D3"
    ...
    <a href="http://www.tax.state.ny.us" target="_blank">
      <path id="NY" class="state-active" data-info="<div>State: New York</div><div>Capital: Albany</div>" fill="#D3D3D3"
    ...
    <a href="http://www.state.nj.us/treasury/index.shtml" target="_blank">
      <path id="NJ" class="state-active" data-info="<div>State: New Jersey</div><div>Capital: Trenton</div>"
        fill="#D3D3D3"
    ...
    <a href="http://www.revenue.state.pa.us" target="_blank">
      <path id="PA" class="state-active" data-info="<div>State: Pennsylvania</div><div>Capital: Harrisburg</div>"
        fill="#D3D3D3"
    ...
    <a href="http://www.state.de.us/revenue/default.shtml" target="_blank">
      <path id="DE" class="state-active" data-info="<div>State: Delaware</div><div>Capital: Dover</div>" fill="#D3D3D3"
    ...
    <a href="http://www.comp.state.md.us/default.asp" target="_blank">
      <path id="MD" class="state-active" data-info="<div>State: Maryland</div><div>Capital: Annapolis</div>"
        fill="#D3D3D3"
    ...
    <a href="http://www.state.wv.us/taxrev" target="_blank">
      <path id="WV" class="state-active" data-info="<div>State: West Virginia</div><div>Capital: Charleston</div>"
        fill="#D3D3D3"
    ...
    <a href="http://revenue.ky.gov" target="_blank">
      <path id="KY" class="state-active" data-info="<div>State: Kentucky</div><div>Capital: Frankfort</div>"
        fill="#D3D3D3"
    ...
    <a href="http://www.state.oh.us/tax" target="_blank">
      <path id="OH" class="state-active" data-info="<div>State: Ohio</div><div>Capital: Columbus</div>" fill="#D3D3D3"
    ...
    <a href="http://www.michigan.gov/treasury" target="_blank">
      <path id="MI" class="state-active" data-info="<div>State: Michigan</div><div>Capital: Lansing</div>"
        fill="#D3D3D3"
    ...
    <path id="WY" data-info="<div>State: Wyoming</div><div>Capital: Cheyenne</div>" fill="#D3D3D3"
    ...
    <a href="http://www.state.mt.us/revenue" target="_blank">
      <path id="MT" class="state-active" data-info="<div>State: Montana</div><div>Capital: Helena</div>" fill="#D3D3D3"
    ...
    <a href="http://tax.idaho.gov/index.html" target="_blank">
      <path id="ID" data-info="<div>State: Idaho</div><div>Capital: Boise</div>" class="state-active" fill="#D3D3D3"
    ...
    <path id="WA" data-info="<div>State: Washington</div><div>Capital: Olympia</div>" fill="#D3D3D3"
    ...
    <path id="TX" data-info="<div>State: Texas</div><div>Capital: Austin</div>" fill="#D3D3D3"
    ...
    <a href="http://www.ftb.ca.gov" target="_blank">
      <path id="CA" class="state-active" data-info="<div>State: California</div><div>Capital: Sacramento</div>"
        fill="#D3D3D3"
    ...
    <a href="http://www.revenue.state.az.us" target="_blank">
      <path id="AZ" class="state-active" data-info="<div>State: Arizona</div><div>Capital: Phoenix</div>" fill="#D3D3D3"
    ...
    <path id="NV" data-info="<div>State: Nevada</div><div>Capital: Carson City</div>" fill="#D3D3D3"
    ...
    <a href="http://tax.utah.gov" target="_blank">
      <path id="UT" class="state-active" data-info="<div>State: Utah</div><div>Capital: Salt Lake City</div>"
        fill="#D3D3D3"
    ...
    <a href="http://www.taxcolorado.com" target="_blank">
      <path id="CO" class="state-active" data-info="<div>State: Colorado</div><div>Capital: Denver</div>" fill="#D3D3D3"
    ...
    <a href="http://www.state.nm.us/tax" target="_blank">
      <path id="NM" class="state-active" data-info="<div>State: New Mexico</div><div>Capital: Santa Fe</div>"
        fill="#D3D3D3"
    ...
    <a href="http://www.oregon.gov/DOR" target="_blank">
      <path id="OR" class="state-active" data-info="<div>State: Oregon</div><div>Capital: Salem</div>" fill="#D3D3D3"
    ...
    <a href="http://www.nd.gov/tax/index.html" target="_blank">
      <path id="ND" class="state-active" data-info="<div>State: North Dakota</div><div>Capital: Bismarck</div>"
        fill="#D3D3D3"
    ...
    <path id="SD" data-info="<div>State: South Dakota</div><div>Capital: Pierre</div>" fill="#D3D3D3"
    ...
    <a href="http://www.revenue.state.ne.us/index.html" target="_blank">
      <path id="NE" class="state-active" data-info="<div>State: Nebraska</div><div>Capital: Lincoln</div>"
        fill="#D3D3D3"
    ...
    <a href="http://www.state.ia.us/tax/index.html" target="_blank">
      <path id="IA" class="state-active" data-info="<div>State: Iowa</div><div>Capital: Des Moines</div>" fill="#D3D3D3"
    ...
    <a href="http://www.dor.ms.gov/" target="_blank">
      <path id="MS" class="state-active" data-info="<div>State: Mississippi</div><div>Capital: Jackson</div>"
        fill="#D3D3D3"
        d="M798.6,567l-0.3,1.3h-5.2l-1.5-0.8l-2.1-0.3l-6.8,1.9l-1.8-0.8l-2.6,4.2l-1.1,0.8l-1.1-2.5   l-1.1-3.9l-3.4-3.2l1.1-7.5l-0.7-0.9l-1.8,0.2l-8.2,0.7l-24.2,0.7l-0.5-1.6l0.7-8l3.4-6.2l5.3-9.1l-0.9-2.1h1.1l0.7-3.2l-2.3-1.8   l0.2-1.8l-2.1-4.6l-0.3-5.3l1.4-2.7l-0.4-4.3l-1.4-3l1.4-1.4l-1.4-2.1l0.5-1.8l0.9-6.2l3-2.7l-0.7-2.1l3.7-5.3l2.7-0.9v-2.5   l-0.7-1.4l2.7-5.3l2.7-1.1l0.1-3.4l8.7-0.1l24.1-1.9l4.6-0.2l0,6.4l0.2,16.7l-0.8,31l-0.2,14.1l2.7,18.8L798.6,567z" />
    </a>

    <a href="http://www.ai.org/dor/index.html" target="_blank">
      <path id="IN" class="state-active" data-info="<div>State: Indiana</div><div>Capital: Indianapolis</div>"
        fill="#D3D3D3"
    ...
    <a href="http://www.revenue.state.il.us" target="_blank">
      <path id="IL" class="state-active" data-info="<div>State: Illinois</div><div>Capital: Springfield</div>"
        fill="#D3D3D3"
    ...
    <a href="http://www.state.mn.us/ebranch/mdor" target="_blank">
      <path id="MN" class="state-active" data-info="<div>State: Minnesota</div><div>Capital: Saint Paul</div>"
        fill="#D3D3D3"
    ...
    <a href="http://www.dor.state.wi.us" target="_blank">
      <path id="WI" class="state-active" data-info="<div>State: Wisconsin</div><div>Capital: Madison</div>"
        fill="#D3D3D3"
    ...
    <a href="http://www.dor.mo.gov" target="_blank">
      <path id="MO" class="state-active" data-info="<div>State: Missouri</div><div>Capital: Jefferson City</div>"
        fill="#D3D3D3"
    ...
    <a href="http://www.state.ar.us" target="_blank">
      <path id="AR" class="state-active" data-info="<div>State: Arkansas</div><div>Capital: Little Rock</div>"
        fill="#D3D3D3"
    ...
    <a href="http://www.oktax.state.ok.us" target="_blank">
      <path id="OK" class="state-active" data-info="<div>State: Oklahoma</div><div>Capital: Oklahoma City</div>"
        fill="#D3D3D3"
    ...
    <a href="http://www.ksrevenue.org" target="_blank">
      <path id="KS" class="state-active" data-info="<div>State: Kansas</div><div>Capital: Topeka</div>" fill="#D3D3D3"
    ...
    <a href="http://www.rev.state.la.us" target="_blank">
      <path id="LA" class="state-active" data-info="<div>State: Louisiana</div><div>Capital: Baton Rouge</div>"
        fill="#D3D3D3"
    ...
    <a href="http://www.tax.virginia.gov" target="_blank">
      <path id="VA" class="state-active" data-info="<div>State: Virginia</div><div>Capital: Richmond</div>"
        fill="#D3D3D3"
    ...
    <a href="http://dor.wa.gov" target="_blank">
      <g id="DC">
        <path id="path58" class="state-active" fill="#D3D3D3"
          d="M975.8,353.8l-1.1-1.6l-1-0.8l1.1-1.6l2.2,1.5L975.8,353.8z" />
        <circle id="circle60" class="state-active" data-info="<div>Washington DC</div>" fill="#D3D3D3" stroke="#FFFFFF"
          stroke-width="1.5" cx="975.3" cy="351.8" r="5" />
      </g>
    </a>
