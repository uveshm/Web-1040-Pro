...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#Humburger').click(function () {
    // huuberger active
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#Humburger').toggleClass('active');
    // nav open
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.tree li.parent_li > span').on('click', function (e) {
    ...
    if (children.is(":visible")) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('title', 'Expand this branch').parent().addClass('close').removeClass('open');
    } else {
      children.show('fast');
      // $(this).attr('title', 'Collapse this branch').find(' > i').addClass('icon-minus-sign').removeClass('icon-plus-sign');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('title', 'Collapse this branch').parent().addClass('open').removeClass('close');
    }
    e.stopPropagation();
  });
});
...
if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).width() < 767) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').removeClass('nav-open');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#Humburger').removeClass('active');
} else {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').addClass('nav-open');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#Humburger').addClass('active');
}
...
(function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("a.new-window").click(function (e) {
    var popupWidth = 1650;
    var leftPos = screen.width - popupWidth;
    e.preventDefault();
    window.open(this.href, "customWindow", "width=" + popupWidth + ", height=740, top=200, left=" + leftPos);
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("path, circle").hover(function (e) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#info-box').css('display', 'block');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#info-box').html(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('info'));
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("path, circle").mouseleave(function (e) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#info-box').css('display', 'none');
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).mousemove(function (e) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#info-box').css('top', e.pageY - jquery__WEBPACK_IMPORTED_MODULE_0___default()('#info-box').height() - 30);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#info-box').css('left', e.pageX - jquery__WEBPACK_IMPORTED_MODULE_0___default()('#info-box').width() / 2);
  }).mouseover();
  var ios = /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream;
  if (ios) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('a').on('click touchend', function () {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkweb_1040_pro"] = self["webpackChunkweb_1040_pro"] || [];
